...
class CertForm(forms.ModelForm):
    ...
    doctor_address = forms.CharField(widget=forms.Textarea(attrs={"placeholder":"Doctor's Address with Name","class"      : "new-class-name two",
    ...
    Consult_fee1 = forms.DecimalField(initial=0.00,required=False)
    Injection_fee1     = forms.DecimalField(initial=0.00,required=False)
    ...
    Consult_fee2 = forms.DecimalField(initial=0.00,required=False)
    Injection_fee2     = forms.DecimalField(initial=0.00,required=False)
    
    Med_name1      = forms.CharField(label='Medicine',widget=forms.TextInput(attrs={"placeholder":"Medicine"}))
    Quantity1       = forms.IntegerField()
    Price1     = forms.DecimalField(initial=0.00)
    ...
    Price2     = forms.DecimalField(initial=0.00,required=False)
    ...
    Diagnostic_Test_price1  = forms.DecimalField(initial=0.00)
    ...
    Diagnostic_Test_price2  = forms.DecimalField(initial=0.00,required=False)
